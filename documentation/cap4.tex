...
Box2D provee un elemento para dibujar los objetos del mundo en el \emph{canvas} de HTML5, \texttt{b2DebugData}. Este pinta la forma de los cuerpos sobre el \emph{canvas} automáticamente. 

...
\begin{itemize}
	...
	\item \texttt{sensorNW}: Sensor en la posición Noroeste.
		\item \texttt{sensorNE}: Sensor en la posición Noreste.
			\item \texttt{sensorSW}: Sensor en la posición Suroeste.
				\item \texttt{sensorSE}: Sensor en la posición Sureste.

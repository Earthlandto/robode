...
Para que las funciones sean parte del lenguaje y se ejecuten como una más de iJava, hay que realizar tres grandes cambios. Estos son: (a) añadir la definición de las funciones al analizados sintáctico; (b) añadir la implementación de las funciones al \emph{sandbox} y (c) modificar el analizador semántico para cambiar la función principal \texttt{main} por \texttt{setup}.

En la sección \ref{sec:integracion-descubre} se analizan las clases con funciones

...
Una característica del simulador que estaba clara desde el comienzo del proyecto era la necesidad de que el robot pudiera seguir líneas. Para poder seguir líneas, es necesario poder calcular la distancia del robot a una línea. Esto implica el cálculo de la distancia de un punto a una línea. Pero, ¿qué forma tiene la línea?

Hay dos opciones para la forma de las líneas: líneas rectas o curvas. Las líneas rectas darían una forma muy simple al circuito y no se corresponden con los circuitos que podrían crearse en la realidad. Además, la programación del robot sigue-líneas sería muy simple para el niño (solo tendría que asegurarse de que cuando encuentra una línea, no se tuerce). Así que esto elimina la opción de usar rectas para modelar las líneas. 

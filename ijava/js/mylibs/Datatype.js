...
var ObjectDatatype = new ClassDatatype({
    id: 'Object',
    line: 0,
    col: 0,
    from: 0,
...
ObjectDatatype.addMethod("equals", BooleanDatatype, [{
...
var StringDatatype = new ClassDatatype({
    id: 'String',
    line: 0,
    col: 0,
    from: 0,
...
StringDatatype.addMethod("charAt", CharDatatype, [{
    datatype: IntegerDatatype
}]);
StringDatatype.addMethod("equals", BooleanDatatype, [{
    datatype: ObjectDatatype
}]); // StringDatatype
StringDatatype.addMethod("concat", StringDatatype, [{
    datatype: StringDatatype
}]);
StringDatatype.addMethod("compareTo", IntegerDatatype, [{
    datatype: StringDatatype
}]);
StringDatatype.addMethod("indexOf", IntegerDatatype, [{
    datatype: CharDatatype
}]);
StringDatatype.addMethod("substring", StringDatatype, [{
    datatype: IntegerDatatype
}]);
StringDatatype.addMethod("substring", StringDatatype, [{
    datatype: IntegerDatatype

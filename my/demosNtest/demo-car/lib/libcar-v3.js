...
function demoCar() {
    ...
    var fc = wheel(xx, yy-.5); // front center wheel
    var fr = wheel(xx + .53, yy+.5); //front right wheel
    var fl = wheel(xx - .53, yy+.5); //front left wheel
    ...
    var jfc = revJoint(car, fc); // Joint between car body and front center wheel
    ...
    function revJoint(body1, wheel) {
        ...
        revoluteJointDef.maxMotorTorque = 99999999999999999;
